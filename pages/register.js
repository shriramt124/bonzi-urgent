      ...
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-8 flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4 mb-4">
          <div className="flex flex-col sm:flex-row gap-2">
            <input type="text" placeholder="First name" className="w-full sm:flex-1 border border-gray-300 rounded px-3 py-2 text-sm text-black focus:outline-none focus:border-orange-500" required />
            <input type="text" placeholder="Last name" className="w-full sm:flex-1 border border-gray-300 rounded px-3 py-2 text-sm text-black focus:outline-none focus:border-orange-500" required />
          </div>
          <input type="tel" placeholder="Phone number" className="border border-gray-300 rounded px-3 py-2 text-sm text-black focus:outline-none focus:border-orange-500" required />
          ...
          <input type="password" placeholder="New Password" className="border border-gray-300 rounded px-3 py-2 text-sm text-black focus:outline-none focus:border-orange-500" required />
          <button type="submit" className="bg-gradient-to-r from-orange-500 to-orange-400 text-white font-semibold py-2 rounded mt-2 hover:from-orange-600 hover:to-orange-500 transition-colors">Sign Up</button>
        </form>
        <div className="w-full flex flex-col items-center mt-2">
          <span className="text-gray-500 text-sm mb-2">Sign up With</span>
